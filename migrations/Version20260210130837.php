 ...
 */
final class Version20260210130837 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE candidat CHANGE uuid uuid VARCHAR(36) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE candidat CHANGE uuid uuid VARCHAR(30) NOT NULL');
